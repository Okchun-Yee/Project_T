...
public class AutoLoot : MonoBehaviour
{
    ...
    [SerializeField] readonly private AutoLootType lootType;    // 자동 루팅 아이템 타입
    [SerializeField] private float lootDistance = 5f;           // 플레이어가 아이템을 감지하는 거리
    [SerializeField] private readonly float accelerationRate = .2f; // 플레이어에게 다가갈 때 가속도
    ...
    [SerializeField] private readonly float heightY = 1.5f;     // 아이템이 튀어오르는 높이
    [SerializeField] private readonly float popDuration = 1f;   // 아이템이 튀어오르는 애니메이션 지속 시간 
